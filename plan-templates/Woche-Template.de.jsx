// Datei: WOCHE-XX-YYYY-MM-DD.de.jsx
...
export const meta = {
  ...
  id: "woche-4-YYYY-MM-DD",
  lang: "de",
  sidebar: "[DE] Woche X (YYYY-MM-DD)",
};
...
function Tests() {
  try {
    if (!/^Woche X \d{4}-\d{2}-\d{2}$/.test(FILE_BASE)) throw new Error("FILE_BASE Regex");
