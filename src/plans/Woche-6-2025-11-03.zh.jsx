...
// 严格沿用 Woche-5-2025-10-27.zh.jsx 的结构与功能（1:1），仅更新 Meta 与 DATA
...
const DATA = [
  ...
  },
  {
    ...
    ingredients: ["素面（干） 110 g", "香菇 140 g", "香葱 20 g", "浅色味噌 18 g", "清水 1000 ml", "低钠酱油 10 ml"],
...
const groupMap = {
  ...
  season: ["昆布", "海苔", "高汤", "蔬菜高汤", "酱油", "味噌", "香油", "橄榄油", "味醂", "蜂蜜", "盐", "芝麻", "蒜", "姜", "水", "清水", "绿茶"],
};
